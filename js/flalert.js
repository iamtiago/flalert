 ...
 *
 * Simple (& Flat) jQuery Alert / Notification Plugin
 *
*/

;(function ( $, window, document, undefined ) {
    
    $.flalert = function(message, options)
    {
        /* defaults */
        ...
        if($('[class="flalert ' + settings.position + '"]').length == 0){

            $aside = '<aside class="flalert ' + settings.position + '"></aside>';
            $('body').append($aside);
        ...
        $holder = $('[class="flalert ' + settings.position + '"]');
